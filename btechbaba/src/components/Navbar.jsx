        ...
        <nav className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 sticky top-0 z-50 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link to="/#notes" onClick={(e) => handleNavClick(e, 'notes')} className="nav-link-animated text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 font-medium transition-colors cursor-pointer">Notes</Link>
                        <Link to="/#pyq" onClick={(e) => handleNavClick(e, 'pyq')} className="nav-link-animated text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 font-medium transition-colors cursor-pointer">PYQ</Link>
            ...
            {isOpen && (
                <div className="mobile-menu-enter md:hidden bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-4 py-4 space-y-4 shadow-lg absolute w-full left-0 z-40 transition-colors duration-300">
                    ...
                    <Link to="/#notes" className="nav-link-animated block text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 font-medium" onClick={(e) => handleNavClick(e, 'notes')}>Notes</Link>
                    <Link to="/#pyq" className="nav-link-animated block text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 font-medium" onClick={(e) => handleNavClick(e, 'pyq')}>PYQ</Link>
